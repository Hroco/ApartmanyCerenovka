...
export default function ApartmentSite() {
  ...
  return (
    <>
      <Head>
        <title>{t.BannerCountryRoom + " - " + t.AboutPageHeading}</title>
        <meta
          name="description"
          content={
            t.BannerCountryRoom + " - " + t.ApartmentCountryRoomDescription
          }
        ></meta>
      ...
      <div className="main-panel">
        <BannerImg text={`${t.BannerCountryRoom}`} />
        <div className="main-panel-inside container">
          <div className="apartman-large-content">
            <h2>{`${t.BannerCountryRoom} ( ${apartmentData?.beds} + ${apartmentData?.extraBeds} )  - ${apartmentData?.size}`}</h2>
            <div className="apartman-main-description">
              <p>{t.ApartmentCountryRoomDescription}</p>
            </div>
